...
use aegis_core::{
    ...
    ResearchCandidateImportBundlePreview, ResearchCandidateImportBundlePreviewRequest,
    ResearchCandidateImportBundleRequest, ResearchCandidateImportBundleResult,
...
impl ApiClient {
    ...
    pub async fn market_provider_health(
        &self,
        provider: &str,
    ) -> Result<ProviderHealthResponse, ApiClientError> {
        self.get(
    ...
    pub async fn get_cross_asset_relative_strength_v1_dossier(
        &self,
    ) -> Result<CrossAssetRelativeStrengthV1DossierResponse, ApiClientError> {
        self.get("/research/cross-asset/relative-strength-v1/dossier", &[])
            .await
    }

    pub async fn get_cross_asset_relative_strength_v1_candidate_gate_preview(
        &self,
    ) -> Result<CrossAssetCandidateGatePreviewResponse, ApiClientError> {
        self.get(
            "/research/cross-asset/relative-strength-v1/candidate-gate-preview",
            &[],
        )
        .await
    }
...
pub struct ProviderHealthResponse {
    pub health: MarketProviderHealth,
    pub websocket_checked: bool,
...
pub struct ResearchCandidateResponse {
    ...
    pub evidence_provenance: Option<ResearchCandidateEvidenceProvenance>,
    pub request_id: String,
    pub correlation_id: String,
    pub timestamp: DateTime<Utc>,
}
...
pub struct CrossAssetEvidenceReviewReport {
    ...
    pub base_required_independent_observation_count: i64,
    pub required_independent_observation_count: i64,
    pub effective_required_independent_observation_count: i64,
    pub review_extension_active: bool,
    pub review_events_count: i64,
    pub duplicate_extension_warning: bool,
    pub latest_review_decision: Option<String>,
    pub latest_review_decision_at: Option<DateTime<Utc>>,
...
#[derive(Debug, Deserialize, Serialize)]
pub struct CrossAssetRelativeStrengthV1DossierResponse {
    pub dossier: CrossAssetRelativeStrengthV1Dossier,
    pub request_id: String,
    pub correlation_id: String,
    pub timestamp: DateTime<Utc>,
}
...
pub fn build_strategy_experiment_request(
    ...
    let request = StrategyExperimentRequest {
        ...
        min_close_above_sma_pct_candidates: args.min_close_above_sma_pct.clone(),
        max_close_above_sma_pct_candidates: args.max_close_above_sma_pct.clone(),
        min_momentum_return_pct_candidates: args.min_momentum_return_pct.clone(),
...
pub fn build_strategy_config_request(
    ...
    Ok(StrategyConfigUpdateRequest {
        ...
        min_range_width_pct: None,
        max_range_width_pct: None,
        min_close_above_sma_pct: args.min_close_above_sma_pct,
        max_close_above_sma_pct: args.max_close_above_sma_pct,
                ...
                (
                    ...
                    json_response(serde_json::json!({
                        "summary": {
                            ...
                            "latest_formal_observation_at": null,
                            ...
                            "latest_linked_shadow_run_id": null,
                            "latest_linked_shadow_decision": null,
                            "latest_linked_shadow_status": null,
                            "latest_linked_shadow_run_at": null,
                            "latest_valid_shadow_run_id": null,
                            "latest_valid_shadow_decision": null,
                            "latest_valid_shadow_status": null,
                            "latest_valid_shadow_run_at": null,
                            "latest_skipped_shadow_run_at": null,
                            "linked_shadow_completed_count": 0,
                            "linked_shadow_no_signal_count": 0,
                            "linked_shadow_would_submit_count": 0,
                            "linked_shadow_risk_rejected_count": 0,
                            "linked_shadow_skipped_count": 0,
                            "shadow_observation_status": null,
