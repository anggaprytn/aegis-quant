...
.PHONY: fmt fmt-check check test test-no-run-db integration-test dashboard-typecheck dashboard-build demo-syntax diff-check verify demo compose-up compose-down
